...
*/define(["require", "exports"], (function(require, exports) {
    ...
    var hash, empty, isHashTrie, tryGetHash, tryGet, getHash, get, hasHash, has, setHash, set, modifyHash,
            modify, removeHash, remove, fold, pairs, count, keys, values, BUCKET_SIZE = Math.pow(2, 4),
        mask = (BUCKET_SIZE - 1),
        nothing = ({});
    (hash = (function(str) {
    ...
    var Leaf = (function(hash0, key, value) {
        ...
        mergeLeaves = (function(shift, n1, n2) {
            ...
            return ((h1 === h2) ? new(Collision)(h1, [n2, n1]) : ((subH1 = ((h1 >>> shift) & mask)), (subH2 =
                ((h2 >>> shift) & mask)), ((subH1 === subH2) ? create1Internal(subH1, mergeLeaves((
                shift + 4), n1, n2)) : create2Internal(subH1, n1, subH2, n2))));
        }),
    ...
    (Leaf.prototype.modify = (function(shift, f, h, k) {
        ...
        return ((k === self.key) ? ((v = f(self.value)), ((nothing === v) ? null : new(Leaf)(h, k, v))) :
            ((v0 = f()), ((nothing === v0) ? self : ((n2 = new(Leaf)(h, k, v0)), (h1 = self.hash), (h2 =
                n2.hash), ((h1 === h2) ? new(Collision)(h1, [n2, self]) : ((subH1 = ((h1 >>>
                shift) & mask)), (subH2 = ((h2 >>> shift) & mask)), ((subH1 ===
                subH2) ? create1Internal(subH1, mergeLeaves((shift + 4), self,
                n2)) : create2Internal(subH1, self, subH2, n2))))))));
    }));
    (Collision.prototype.modify = (function(shift, f, h, k) {
        var self = this,
            first, rest, v, list = self.children,
            list0 = ((!list.length) ? [] : ((first = list[0]), (rest = list.slice(1)), ((first.key ===
                k) ? ((v = f(first.value)), ((nothing === v) ? rest : [v].concat(rest))) : [
                first
            ].concat(updateCollisionList(rest, f, k)))));
    ...
    (InternalNode.prototype.modify = (function(shift, f, h, k) {
        ...
        return (((!child) && (!(!newChild))) ? new(InternalNode)((self.count + 1), arrayUpdate(frag,
            newChild, self.children)) : (((!(!child)) && (!newChild)) ? (((self.count - 1) <= 0) ?
                newChild : new(InternalNode)((self.count - 1), arrayRemove(frag, self.children))) :
